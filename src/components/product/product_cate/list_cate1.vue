            ...
            <div style="margin-top: 10px">
                <el-form :inline="true"  size="small" label-width="140px" :model="productCate" :rules="rules" ref="productCateFrom">
                    ...
                    <el-form-item label="分类名称：">
                        <el-input style="width: 203px" v-model="productCate.categoryName" placeholder="分类名称"></el-input>
                    </el-form-item>
                    <!-- <el-form-item label="上级分类：">
                        <el-select style="width: 203px" v-model="productCate.categorys" placeholder="全部" clearable >
                    ...
                    <!-- <el-form-item label="是否显示：" style="width:343px">
